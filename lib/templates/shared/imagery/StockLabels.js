...
export default function StockLabels() {
  useEffect(() => {
    ...
    const visibleRect = (img) => {
      ...
      // Only where the tag fits inside the photo; a tag hanging off a thumbnail
      // would cover the text beside it.
      return box.right - box.left > 140 && box.bottom - box.top > 80 ? box : null
    }
