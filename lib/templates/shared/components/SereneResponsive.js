 ...
 */
// `border` is the family's border role, so stacked-column dividers follow the
// palette like every other line on the page.
export default function SereneResponsive({ border }) {
  return (
