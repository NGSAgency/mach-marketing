          ...
          <div style={{ maxWidth: 1200, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1.2fr', gap: 64 }}>
            <div>
              <div style={{ background: T.colors.bgInverse, color: T.colors.textInverse, padding: 40, borderRadius: T.radius.lg, marginBottom: 16 }}>
                ...
                <a href={`tel:${c.business.phone}`} style={{ fontSize: 48, fontWeight: 800, color: T.colors.textInverse, textDecoration: 'none', display: 'block', letterSpacing: -1.5 }}>{c.business.phone_display}</a>
            ...
            <div>
              <form style={{ background: T.colors.bgSecondary, padding: 40, borderRadius: T.radius.lg }}>
                ...
                <button type="submit" style={{ width: '100%', background: T.colors.accent, color: T.colors.bg, border: 'none', padding: '18px 24px', fontSize: 17, fontWeight: 600, borderRadius: T.radius.full, cursor: 'pointer' }}>Request quote →</button>
              </form>
            </div>
          </div>
        </section>
