    ...
    <>
      ...
      <div style={{ background: T.colors.bg, color: T.colors.text, fontFamily: T.fonts.body, minHeight: '100vh' }}>
        ...
        {categories.length > 0 && (
          <section style={{ background: T.colors.bgAlt, padding: '96px 32px' }}>
            <div style={{ maxWidth: 1240, margin: '0 auto' }}>
              <h2 style={{ fontFamily: T.fonts.display, fontSize: 56, fontWeight: 500, letterSpacing: -1.5, textAlign: 'center', margin: '0 0 64px 0' }}>Our Services</h2>
              {categories.map(cat => (
        ...
        <section style={{ background: T.colors.accent, padding: '96px 32px', textAlign: 'center' }}>
          <h2 style={{ fontFamily: T.fonts.display, fontSize: 56, fontWeight: 500, letterSpacing: -1, color: T.colors.bgLight, margin: '0 0 32px 0' }}>Ready when you need us.</h2>
