      ...
      <div style={{ background: T.colors.bg, color: T.colors.text, fontFamily: T.fonts.body, minHeight: '100vh' }}>
        ...
        <section style={{ background: T.colors.bgSecondary, padding: '120px 32px' }}>
          <div style={{ maxWidth: 900, margin: '0 auto' }}>
            <h2 style={{ fontSize: 48, fontWeight: 800, letterSpacing: -1.5, margin: '0 0 32px 0', lineHeight: 1.1 }}>Why {c.business.display_name.split(' ')[0]} for {service.name.toLowerCase()}.</h2>
            ...
            <div style={{ marginTop: 48, background: T.colors.bg, padding: 40, borderRadius: T.radius.lg, boxShadow: T.shadow.subtle }}>
              <div style={{ fontSize: 20, fontWeight: 700, marginBottom: 24, letterSpacing: -0.3 }}>Every job includes</div>
        ...
        <section style={{ background: T.colors.bg, padding: '120px 32px' }}>
          <div style={{ maxWidth: 1200, margin: '0 auto' }}>
            <h2 style={{ fontSize: 48, fontWeight: 800, letterSpacing: -1.5, margin: '0 0 12px 0' }}>{service.name} near you.</h2>
        ...
        {relatedServices.length > 0 && (
          <section style={{ background: T.colors.bgSecondary, padding: '120px 32px' }}>
            <div style={{ maxWidth: 1200, margin: '0 auto' }}>
              <h2 style={{ fontSize: 48, fontWeight: 800, letterSpacing: -1.5, margin: '0 0 40px 0' }}>Related {service.category.toLowerCase()} services.</h2>
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 16 }}>
                {relatedServices.map(svc => (
                  <a key={svc.slug} href={`/templates/axis/services/${svc.slug}`} style={{ textDecoration: 'none', background: T.colors.bg, padding: 32, borderRadius: T.radius.lg, display: 'block', boxShadow: T.shadow.subtle, border: `1px solid ${T.colors.borderLight}` }}>
                    ...
                    <div style={{ fontSize: 20, fontWeight: 700, color: T.colors.text, letterSpacing: -0.3 }}>{svc.name}</div>
