      ...
      <div style={{ background: T.colors.bg, color: T.colors.text, fontFamily: T.fonts.body, minHeight: '100vh' }}>
        ...
        <section style={{ background: T.colors.bg, padding: '80px 32px 96px' }}>
          <div style={{ maxWidth: 1080, margin: '0 auto' }}>
            ...
            <h1 style={{ fontFamily: T.fonts.display, fontSize: 72, fontWeight: 500, letterSpacing: -2.5, margin: '0 0 28px 0', lineHeight: 1.02, color: T.colors.text, maxWidth: 800 }}>
        ...
        <GroveCTA config={c} headline={`Ready for ${service.name.toLowerCase()}?`} sub="Give us a call. Same-day response most days." />
