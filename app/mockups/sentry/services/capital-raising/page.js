...
export const metadata = { title: 'Capital Raising - Sentry Solutions', robots: { index: false, follow: false } }

export default function ServicePage() {
  const service = SERVICES.find(s => s.slug === 'capital-raising')
  if (!service) notFound()

  const otherServices = SERVICES.filter(s => s.slug !== 'capital-raising')
