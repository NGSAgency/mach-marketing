...
export const metadata = { title: 'Exit Planning - Sentry Solutions', robots: { index: false, follow: false } }

export default function ServicePage() {
  const service = SERVICES.find(s => s.slug === 'exit-planning')
  if (!service) notFound()

  const otherServices = SERVICES.filter(s => s.slug !== 'exit-planning')
