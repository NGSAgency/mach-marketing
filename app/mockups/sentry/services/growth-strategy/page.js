...
export const metadata = { title: 'Growth Strategy - Sentry Solutions', robots: { index: false, follow: false } }

export default function ServicePage() {
  const service = SERVICES.find(s => s.slug === 'growth-strategy')
  if (!service) notFound()

  const otherServices = SERVICES.filter(s => s.slug !== 'growth-strategy')
