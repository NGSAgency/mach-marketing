...
export const metadata = { title: 'Fractional CFO - Sentry Solutions', robots: { index: false, follow: false } }

export default function ServicePage() {
  const service = SERVICES.find(s => s.slug === 'fractional-cfo')
  if (!service) notFound()

  const otherServices = SERVICES.filter(s => s.slug !== 'fractional-cfo')
