...
export const SERVICES = [
  { tag: '01', name: 'Growth Strategy', short: 'Financially grounded growth planning', body: 'We help businesses design and execute financially grounded growth strategies, whether that includes purely organic strategies or inorganic acquisition of complementary businesses. Every strategy is built on rigorous financial modeling and market analysis.' },
  { tag: '02', name: 'Capital Raising', short: 'From modeling to close', body: 'We help companies prepare for and navigate the capital raising process. From financial modeling and investor materials to capital structure design and negotiations with lenders and equity partners, we guide you through every stage.' },
  { tag: '03', name: 'Exit Planning', short: 'Years of preparation, one great outcome', body: 'Good exit planning means a well run process. Great exit planning happens in the years leading up to it. Our work includes transaction preparation, valuation optimization, buyer identification, and negotiation support.' },
  ...
  { tag: '05', name: 'Financial Operations', short: 'Day-to-day infrastructure that scales', body: 'From bookkeeping and accounts receivable to payroll and reporting, we manage the day-to-day financial infrastructure that keeps your business running efficiently and gives you clean data to make better decisions.' },
  { tag: '06', name: 'Advisory & Board Services', short: 'A trusted partner in the boardroom', body: 'We serve as strategic advisors and board members to founder-led companies and lower middle market businesses, providing outside perspective, institutional-level expertise, and long-term partnership.' },
]
